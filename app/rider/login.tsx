...
import { Mail, Lock, Bike, ShieldCheck } from 'lucide-react-native';
          ...
          <View style={styles.mobileCard}>
            <View style={styles.logoRow}>
              ...
              <View>
                ...
                <Text style={styles.portalLabel}>Rider Portal</Text>
              </View>
            </View>

            <View style={styles.iconWrap}>
              <Bike size={32} color={Colors.primary} strokeWidth={1.6} />
            </View>

            <Text style={styles.heading}>Rider Sign In</Text>
            <Text style={styles.subheading}>Access your delivery portal</Text>
        ...
        <View style={styles.webLeftContent}>
          <View style={styles.logoRow}>
            ...
            <View>
              ...
              <Text style={[styles.portalLabel, { color: 'rgba(255,255,255,0.75)' }]}>Rider Portal</Text>
            </View>
          </View>

          <View style={styles.webLeftText}>
            <Text style={styles.webHeroTitle}>Deliver happiness,{'\n'}one bouquet at a time</Text>
            <Text style={styles.webHeroSub}>
              View your daily delivery schedule, track assignments, and keep customers smiling.
            </Text>
          </View>

          <View style={styles.featureList}>
            {[
              'View your daily delivery schedule',
              'Track assigned orders in real-time',
        ...
        <View style={styles.webForm}>
          <View style={styles.webFormHeader}>
            <View style={styles.webIconWrap}>
              <Bike size={28} color={Colors.primary} strokeWidth={1.6} />
            </View>
            <Text style={styles.webFormTitle}>Rider Sign In</Text>
            <Text style={styles.webFormSub}>Enter your credentials to access the rider portal</Text>
          </View>
          ...
          <View style={styles.securityNote}>
            ...
            <Text style={styles.securityText}>
              Restricted access — authorized riders only
            </Text>
          </View>
        </View>
      </View>
